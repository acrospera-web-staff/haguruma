...
JGMA 001-01	歯車略号	5,000円（3,500円）	1986(S61)	
JGMA 111-03A	ISO規格に準拠　平歯車およびはすば歯車の穴、軸の直径の公差および円筒度並びに歯先円筒の直径の公差	2,000円（1,400円）	1984(S59)	
JGMA 113-02A	ISO規格に準拠　小モジュール平歯車及びはすば歯車の中心距離の許容値	2,000円（1,400円）	1985(S60)	
JGMA 114-02	ISO規格に準拠　平歯車及びはすば歯車の軸の平行精度	5,000円（3,500円）	1983(S58)	
JGMA 114-02A	小モジュール平歯車及びはすば歯車の軸の平行精度	5,000円（3,500円）	1985(S60)	
JGMA 151-01	鋳造歯車および溶接構造歯車の寸法	5,000円（3,500円）	1973(S48)	
JGMA 405-01	円筒ウォームギヤの強さ計算式	5,000円（3,500円）	1978(S53)	
JGMA 511-01	ISO規格に準拠　円筒歯車の購入仕様	5,000円（3,500円）	1986(S61)	
JGMA 521-01	ISO規格に準拠　すぐばかさ歯車の購入仕様	2,000円（1,400円）	1986(S61)	
JGMA 611-01	ISO規格に準拠　円筒歯車の転位方式	5,000円（3,500円）	1987(S62)	
JGMA 1001-01	歯車の歯面粗さ標準及び測定方法	5,000円（3,500円）	1999(H11)	
JGMA 1002-01	歯車の歯当たり	5,000円（3,500円）	2003(H15)	
JGMA 1101-01	平歯車及びはすば歯車の中心距離の許容値	5,000円（3,500円）	2000(H12)	
JGMA 1102-01	平歯車及びはすば歯車の軸の平行精度	5,000円（3,500円）	2000(H12)	
JGMA 1103-01	歯車精度－平歯車及びはすば歯車のバックラッシ並びに歯厚	5,000円（3,500円）	2003(H15)	
JGMA 1104-01	検査用親円筒歯車規格	5,000円（3,500円）	2010(H22)	
JGMA 2001-01	運動制御用歯車装置の特性及び精度	5,000円（3,500円）	1993(H5)	
JGMA 3001-01	バリ取り標準及び打痕防止	5,000円（3,500円）	1998(H10)	
JGMA 3101-01	円筒歯車の歯切り時間の概算	5,000円（3,500円）	1996(H8)	
JGMA 3102-01	円筒歯車の歯面仕上げ時間の概算	5,000円（3,500円）	1997(H9)	
JGMA 4101-01	円筒歯車の強さ試験方法	5,000円（3,500円）	1994(H6)	
JGMA 4102-01	円筒歯車の強さ試験の判定と評価方法	5,000円（3,500円）	1995(H7)	
JGMA 4301-01	円筒ウォームギヤの強さ計算式	13,000円（10,000円）	2017(H29)	
JGMA 6101-02	平歯車及びはすば歯車の曲げ強さ計算式	7,000円（4,900円）	2007(H19)	
JGMA 6102-02	平歯車及びはすば歯車の歯面強さ計算式	7,000円（4,900円）	2009(H21)	
JGMA 6201-01	かさ歯車の曲げ強さ計算式	7,000円（4,900円）	2012(H24)	
JGMA 6202-01	かさ歯車の歯面強さ計算式	7,000円（4,900円）	2013(H25)	
JGMA 8002-01	ISO規格に準拠　歯車装置検査規定「歯車装置の機械振動測定方法」	5,000円（3,500円）	1991(H3)	
JGMA/TR0001	新旧JIS歯車精度の規格値対比表	5,000円（3,500円）	2000(H12)	
JGMA/TR0002	ISO規格に準拠　平歯車及びはすば歯車の強さ簡易計算式	5,000円（3,500円）	2000(H12)	
JGMA/TR0003	かさ歯車の強さ簡易計算式	5,000円（3,500円）	2001(H13)
...
function selectSet() {
	...
	$items = array(
		...
		"s207" => "JGMA 405-01	円筒ウォームギヤの強さ計算式",
      ...
      <?php if(have_posts()): while(have_posts()):the_post(); ?>
        ...
        <div class="post">
          ...
          <div>
            ...
            <form id="mailformpro" action="<?php echo home_url(); ?>/cgi-bin/acro_mfp_test/mailformpro/mailformpro.cgi?type=book" method="POST">
            <table class="type01 form combi">
              <col width="26%"><col width="74%">
              <tr>
                <td>企業・団体名※</td>
                <td><input type="text" name="企業・団体名" id="ocmName" required="required" />
                  <div class="cbx"><input type="radio" name="所属" id="registed1" value="会員" checked="" required="required" /><label for="type1">会員</label></div>
                  <div class="cbx"><input type="radio" name="所属" id="registed2" value="非会員" /><label for="type2">非会員</label></div>
                </td>
              </tr>
              <tr><td>部署・ご担当者（氏名）※</td><td><input type="text" name="ご担当者" id="name" required="required" /></td></tr>
              <tr><td>住所※</td><td>〒<input type="text" name="郵便番号" id="zip0" required="required" /> 住所<input type="text" name="住所" id="address0" required="required" /></td></tr>
              ...
              <tr><td>メールアドレス※</td><td><input type="text" name="email" id="email" required="required" /></td></tr>
              <tr><td>請求書有無</td><td>
                <div class="cbx"><label for="account_no">無し</label><input type="radio" name="請求書有無" id="account_no" value="無" checked /></div>
                <div class="cbx"><label for="account_yes">有り</label><input type="radio" name="請求書有無" id="account_yes" value="有" /></div>
              </td></tr>
              <tr><td>領収書有無※</td><td>
                <div class="cbx"><label for="receipt_no">無し</label><input type="radio" name="領収書有無" id="receipt_no" value="無" required="required" checked /></div>
                <div class="cbx"><label for="receipt_yes">有り</label><input type="radio" name="領収書有無" id="receipt_yes" value="有" /></div>
              </td></tr>
              <tr><td>お支払予定日※</td><td><input type="date1" name="お支払予定日（月）" id="date1" style="width:10%;" required="required" />月 <input type="date2" name="お支払予定日（日）" id="date2" style="width:10%;" required="required" />日</td></tr>
            </table>
            ...
            <script type="text/javascript" id="mfpjs" src="<?php echo home_url(); ?>/cgi-bin/acro_mfp_test/mailformpro/mailformpro.cgi?type=book" charset="UTF-8"></script>
          </div>
        </div>        
        <?php the_content(); ?>
      <?php endwhile; endif; ?>
