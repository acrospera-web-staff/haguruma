<?php
/*
Template Name: english_members_search
*/
get_header('english'); ?>
<!-- コンテンツ -->
  <section>
...
-->
        <div id="search">
          ...
          <div id="sBox1">
            <p class=""><label for="area1_all">All : </label><input id="area1_all" name="area" type="checkbox" value="all" /></p>
            <ul>
...
<label for="rack_goku">ES </label><input id="rack_goku" name="rack_goku" type="checkbox" value="ON" /></li>
        ...
        <table id="searchResult" class="type01 width925px">
          ...
          <tr>
            ...
            <td></td>
            <td></td>
            <td><a href=""  target="_blank">Web Site</a></td>
          </tr>
