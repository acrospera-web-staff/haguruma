...
-->
        <div id="search">
          ...
          <div id="sBox1">
            <p class=""><label for="area1_all">すべて 　　　　　： </label><input id="area1_all" name="area" type="checkbox" value="all" /></p>
            <ul>
...
<label for="rack_goku">極小 </label><input id="rack_goku" name="rack_goku" type="checkbox" value="ON" /></li>
        ...
        <table id="searchResult" class="type01 width925px">
          <col width="3%"><col width="35%"><col width="34%"><col width="14%"><col width="7%"><col width="7%">
          <tr>
            <th></th>
            <th>会社名</th>
            <th>住　　所</th>
