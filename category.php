...
<div class="content">
  ...
  <?php if(have_posts()): query_posts($query_string.'&posts_per_page=5&paged='.$paged); while(have_posts()): the_post(); //query_posts($query_string.'posts_per_page=2&paged='.$paged); ?>
    <div class="post">
