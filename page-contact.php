      ...
      <?php if(have_posts()): while(have_posts()):the_post(); ?>
        ...
        <div class="post">
          ...
          <div>
            ...
            <?php /*<form id="mailformpro" action="<?php echo get_template_directory_uri(); ?>/acro_mfp/mailformpro/mailformpro.cgi" method="POST">*/ ?>
            ...
            <table class="type01 form">
              ...
              <tr>
                ...
                <td>
                  ...
                  <p style="margin-top: 5px; color: red;">ドメインがGmail、yahoo、outlook、hotmailの場合、まれにメールが届かない事象が起こっておりますので、<br>上記以外のドメインからお問合せいただけますと幸いでございます。</p>
                </td>
              </tr>
              <tr>
                <td>お問い合わせ項目※</td>
